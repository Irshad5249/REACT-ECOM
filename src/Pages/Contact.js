...
const Contact = () => {
  return (
    <>
      ...
      <div container-fluid className="contact-wrapper py-5 home-wrapper-2">
        <div className="row">
                  ...
                  <ul className="ps-0">
                    <li className="mb-3 d-flex gap-15 align-items-center">
                      ...
                      <address className="mb-0">
                        Hno:A-51 , Near Mansaram Park , Sunday Market, New Delhi
                      </address>
                    </li>
                    <li className="mb-3 d-flex gap-15 align-items-center">
                      <BiPhoneCall className="fs-5" />
                      <a href="tel:+91 7860947033">+91 7860947033</a>
                    </li>
                    <li className="mb-3 d-flex gap-15 align-items-center">
                      <AiOutlineMail className="fs-5" />
                      <a href="mailto:aero5249@gmail.com">
                      aero5249@gmail.com
                      </a>
                    </li>
                    <li className="mb-3 d-flex gap-15 align-items-center">
